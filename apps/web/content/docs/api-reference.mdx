...
| issues | ReadonlyArray<{ message: string; path?: ReadonlyArray<PropertyKey> }> | Read-only array of validator issues |
...
| issues | ReadonlyArray<{ message: string; path?: ReadonlyArray<PropertyKey> }> | Validator issues |
